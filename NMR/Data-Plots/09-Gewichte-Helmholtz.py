...
read_start=15 # Erste Zeile, die eingelesen wird
...
if Alle_Daten_plotten==True:
    txt_filename_to_open_minmax=["06-helmholtz-FM-45mA-minmax.dat","06-helmholtz-FM-65mA-minmax.dat","06-helmholtz-FM-80mA-minmax.dat"]
    txt_filename_to_open_maxmin=["06-helmholtz-FM-45mA-maxmin.dat","06-helmholtz-FM-65mA-maxmin.dat","06-helmholtz-FM-80mA-maxmin.dat"]
    #txt_filename_to_open_negminmax=["06-helmholtz-FM-neg45mA-minmax.dat", "06-helmholtz-FM-neg65mA-minmax.dat","06-helmholtz-FM-neg80mA-minmax.dat"]
    #txt_filename_to_open_negmaxmin=["06-helmholtz-FM-neg45mA-maxmin.dat", "06-helmholtz-FM-neg65mA-maxmin.dat","06-helmholtz-FM-neg80mA-maxmin.dat"]
	
    data1 = [i.strip().split() for i in open(txt_filename_to_open_minmax[set]).readlines()]
    data2 = [i.strip().split() for i in open(txt_filename_to_open_maxmin[set]).readlines()]
