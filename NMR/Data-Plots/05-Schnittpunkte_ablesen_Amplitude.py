...
if Alle_Daten_plotten==True:
    txt_filename_to_open=["05-phasenraum-AM-1500Hz-minmax.dat","05-phasenraum-AM-1500Hz-maxmin.dat"]
    ...
    plt.plot(t1,S1,"b.", label="Up-Sweep")
    plt.plot(t2,S2,"g.", label="Down-Sweep")
    ...
    plt.plot([1510,1510],[0.39-0.005,-1],"r--",linewidth=2)
    plt.text(1535,-0.6,r"$\nu_{\mathrm{res}}$",va="center",ha="center",color="red")
