...
%=============================================================================
  \vspace{-2em}
  \noindent {\small 
  	Ein Wasserkreislauf, Polarisator, Manipulator und Analysator ergeben einen Aufbau zur Untersuchung der magnetischen Kernresonanz. Wir bestimmen die Resonanzfrequenz $\nu_{\rm res} = \SI{4712.31}{\kilo\hertz}$ sowie die Energieaufspaltung $\Delta E = \SI{19.48854e-9}{\electronvolt}$. Wir stellen den Phasenraum von Frequenz, Amplitude und Signal dar, zeigen \note{anzahl} Spindrehungen und  bestimmen das Kernmagneton $mu_{\rm K} = \SI[per-mode=symbol]{5.0979e-27}{\tesla\per\ampere}$. Für verschiedene Temperaturen vergleichen wir die Relaxationszeiten und bestimmen das vorhandene Störfeld. Durch verschiedene Messungen können wir die, durch die Bloch-Gleichungen vorhergesagte, Dynamik in großen Teilen bestätigt.
    }
\end{abstract}
...
\end{figure}
% Effekte
%  - Asymmetrie des Signals
%  - unterschiedlich lange in der Manipulatorspule
%  - unterschielich starken Einstrahlfeldern ausgesetzt, die sowohl einen Einfluss auf die Oszillation als auch auf die Halbwertsbreiten haben
%  - schnellere Spindrehung, wenn off-Resonanz



%\begin{compactitem}
%	+ Resonanz im Störfeld finden 
%	+ Phasenraum aufnehmen
%	- Spindrehung aufnehmen
%	+ Wassergeschwindigkeit bestimmen
%	- Vergleich mit Theorie -Halbswertsbreiten 
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Messung der Resonanz im Feld der Helmholtzspulen}
\label{auswertung6}
