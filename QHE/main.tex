...
\begin{figure}[htp]
	...
	\end{center}
\end{figure}
Als Steigung erhalten wir bei $\SI{4.2}{\kelvin}$ die Hall-konstante $A_H=\SI[per-mode=symbol]{1750(100)}{\ohm\per\tesla}$ und aus dieser die Oberflächenladungsdichte
\begin{equation}
N_S=\frac{1}{A_H e} = \SI{3.57(20)e11}{\per\square\centi\meter}.
\label{ns1}
\end{equation}
...
\begin{equation}
T_{\frac{1}{B}}=\SI{1375(31)e-4}{\per\tesla}
\label{periodizitaet}
\end{equation}
...
\begin{equation}
N_S=\frac{2 e}{T_{\frac{1}{B}} h}=\SI{3.517(079)e-11}{\per\square\centi\meter}
\label{ns_periode}
\end{equation}
