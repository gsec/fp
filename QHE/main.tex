...
\begin{compactitem}
	...
	\item Fehler Shuntwiderstand: $5\,\%$
	\item Ablesefehler Hallwiderstand $0.08\%$
	\item Fehler Temperatur\\
		schwer einstellbar, nicht konstant, ändert sich während der Messung,
		Anfangs- und Endtemperatur gemessen und mittlere Abweichung bestimmt
		\begin{compactitem}
			\item für \SI{4.2}{\kelvin} exakt
			\item für \SI{3.0}{\kelvin} $\pm \SI{0.5}{\kelvin}$ um \SI{3.03}{\kelvin}
			\item für \SI{2.1}{\kelvin} $\pm \SI{0.3}{\kelvin}$ um \SI{2.1}{\kelvin}
			\item für \SI{1.5}{\kelvin} $\pm \SI{0.2}{\kelvin}$ um \SI{1.53}{\kelvin}
		\end{compactitem}
\end{compactitem}
% 
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
\begin{table}[htp]
	\begin{center}
		\begin{tabular}{ccccc}
			\hline
			$T[\rm T]$ & $R_{xx}[\Upomega]$ & $\sigma_{\rm 2D}[\frac{1}{\Upomega}]$ & $A_{\rm H}\left[ \frac{\mathrm{m}^2}{\mathrm{C}} \right]$ & $\mu \left[ \frac{\mathrm{m}^2}{\mathrm{C}\Upomega} \right]$\\
			\hline
