...
\begin{figure}[htp]
	\begin{center}
		...
		\caption{Auftragund der Längsspannung über dem Magnetfeld bei $T=\SI{4.2}{\kelvin}$ und \SI{2.1}{\kelvin}, zur Ermittlung des Amplitudenverhältnisses und der Zyklotronmasse.}
...
\begin{figure}[htp]
	\begin{center}
		...
		\caption{Auftragund der Längsspannung über $1/B$ bei $T=\SI{4.2}{\kelvin}$ und \SI{2.1}{\kelvin}, zur Ermittlung des Amplitudenverhältnisses und der Zyklotronmasse.}
