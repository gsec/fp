...
% =============================================================================
  ...
  nachgewiesen. Die Klitzing-Konstante wurde zu $\SI{25.1}{\kilo\ohm}$ bestimmt und Hall-Plateaus bis
  zum Füllfaktor 14 beobachtet. Mit verschiedenen Methoden wurde die 
  Ladungsträgerkonzentration im 2\,DEG untersucht die sich als weitgehendst 
  temperaturunabhängig herausstellte. Bei niedrigen Temperaturen wurde die Zeeman-Aufspaltung beobachtet und 	quantitativ untersucht, um den Landé-Faktor zu bestimmen.   }
\end{abstract}
...
\centerline{\hfill  Protokollabgabe am 19. Oktober 2013}
...
Um die Hallbar anzusteuern, liegt ein Probenbox am Arbeitsplatz, die mit der Hallbar verbunden ist. An den Kontakten 3, 4, 6 und 7 kann die Längsspannung sowie die Querspannung abgegriffen werden. An den Kontakten 5 und 8 wird der Gleichstrom bereitgestellt.
...
wird ein mit \SI{13}{\hertz} und \SI{1}{\volt} betriebener Funktionsgenerator über einen 1000:1 Spannungsteiler und einem Vorwiderstand von $R_{\rm Shunt} = \SI{4981}{\ohm}$ an das Probenbox angelegt und der Spannungsabfall über dem Shuntwiderstand gemessen.

%Die Spannung, die an der Probe anliegt wird am Vorwiderstand abgegriffen. I dont belive you :)
Die Querspannung sowie die Shuntspannung sind über zwei Lock-In-Verstärker mit einem Computer verbunden.
...
% =============================================================================
%
Um die Hall-Plateaus und die Shubnikov-de-Haas Oszillation zu beobachten, messen wird die Shuntspannung $U_{\rm Shunt}$ und die Querspannungen $U_{xx}$ bzw. $U_{\rm Hall}$ bei steigendem Magnetfeld von $0 \rightarrow \SI{9}{\tesla}$ und bei fallendem Magnetfeld von $9 \rightarrow \SI{0}{\tesla}$. Da wir nur zwei Lock-ins verwenden, nehmen wir die Hallspannung $U_{\rm Hall}$ und die Längsspannung $U_{xx}$ in getrennten Messungen auf. An der Probe wird die Hallspannung an den Kontakten 4 und 6, sowie die Längsspannung an den Kontakten 6 und 7 abgegriffen. Durch die Druckregelung des Heliums im Kryostaten können wir die Temperatur regeln und die obigen Messungen bei verschiedenen Temperaturen aufnehmen.
...
Die für jedes sichtbare Niveau ausgelesenen Widerstandswerte haben zusammen mit den Füllfaktoren für jede Temperatur in Tabelle~\ref{klitzing} aufgetragen.
...
%leider nicht den gleichen
 der der Klitzing-Konstante nahe kommt. Diese Werte sind in Tabelle~\ref{klitzing2} aufgetragen.
...
\begin{center}
	\begin{tabular}{rr}
		...
		\hline
		4.2 & \SI[separate-uncertainty=false]{24868(54)}{\ohm} \\
		3.0 & \SI[separate-uncertainty=false]{25255(49)}{\ohm} \\
		2.1 & \SI[separate-uncertainty=false]{25260(49)}{\ohm} \\
		1.5 & \SI[separate-uncertainty=false]{25074(49)}{\ohm}
	\end{tabular}
...
Für jede Temperatur wurde ein Bestwert der Klitzing-Konstante bestimmt. Dazu wurden die Widerstandswerte der Plateaus jeweils mit den entsprechenden Füllfaktoren multipliziert und für den Bestwert gemittelt.
...
\begin{align}
E_F&=N_\mathrm{S} \cdot \frac{\hbar^2 \pi}{m^*}\\
k_F&=\sqrt{2 \pi N_\mathrm{S}}\\
v_F&=\frac{\hbar\sqrt{2 \pi}}{m^*} \sqrt{N_\mathrm{S}}
\end{align}
...
\begin{table}[htp]
	\begin{center}
		\begin{tabular}{rrrrr}
			\hline
			$T[\frac{1}{\mathrm{K}}]$ & $E_F[\mathrm{eV}]$ & $k_F[\SI{}{\per\nano\meter}]$ & $v_F[\SI{}{\kilo\meter\per\second}]$\\
			\hline
...
\begin{equation}
g=\frac{M \hbar e}{\mu_B m_c}=-0.80\pm29.
\end{equation}
...
bestimmt und macht mit etwa $\SI{250}{\kilo\meter\per\second}$ den fermionischen Charakter
