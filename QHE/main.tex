...
\label{ns1}
\end{equation}
Da die in Abbildung \ref{hallsteigung} gezeigte Gerade auch für alle anderen Temperaturen genau den Bereich bei kleinen Magnetfeldern beschreibt, hängt die durch die Gerade des Hall-Widerstandes bestimmte Oberflächenladungsträgerdichte nicht von der Temperatur ab.
