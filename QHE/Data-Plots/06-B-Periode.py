...
#plt.set_xlabel(txt_file[0][0])
#plt.set_ylabel(txt_file[0][1])
plt.ylabel(u'$|\mathrm{DFT}|^2$')
plt.xlabel(u'$\\frac{1}{B}$-Frequenz des Längswiderstandes [T]')
#plt.ylim([0,16000])
plt.xlim([0,65])
title("Frequenzdarstellung von 1/B")
font = {'family' : 'serif',
        'weight' : 'normal',
        'size'   : 20}
matplotlib.rc('font', **font)
subplots_adjust(left=0.13, bottom=0.14, right=0.97, top=0.92, wspace=0.2, hspace=0.2)
